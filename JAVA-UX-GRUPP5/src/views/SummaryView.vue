  ...
  <div class="container">
    <div class="text">
      Nederbörd &nbsp &nbsp &nbsp &nbsp<br /><img
        class="image"
        src="../assets/prototype icons/Group 12.svg"
        alt="rain cloud"
    ...
    <div class="text">
      Soltimmar <br /><img
        class="image"
        src="../assets/prototype icons/Group 7.svg"
        alt="sun"
  ...
  <div class="container">
    <div class="text">
      Varmaste dagen &nbsp<br /><img
        class="image"
        src="../assets/prototype icons/sun-solid 2.svg"
        alt="rain cloud"
      />
    ...
    <div class="text">
      Kallaste dagen <br /><img
        class="image"
        src="../assets/prototype icons/snowflake-solid 3.svg"
        alt="rain cloud"
  ...
  <div class="container">
    <div class="text">
      Blåsigaste dagen <br /><img
        class="image"
        src="../assets/prototype icons/wind-solid 3.svg"
        alt="rain cloud"
      />
